...
export default function About(){
    ...
    return <section id='about' className='flex flex-col md:flex-row px-5 py-20'>
        <div className='py-10 px-20 md:w-1/2'>
            <img src={AboutImg}/>
        </div>
        <div className='md:w-1/2 flex justify-center'> 
            <div className='flex flex-col justify-center'>
                <h1 className='text-4xl border-b-4 border-[#37C8B7] mb-5 w-[170px] font-bold'>About Me</h1>
                <p className='pb-5'>{config.about1}</p>
                <p className='pb-5'>{config.about2}</p>
            </div>
        </div>
    </section>
}